...
Now that you have a set of data files you can read them, optionally with a select number of [OBIS Darwin Core] (https://manual.obis.org/darwin_core.html) requiredand recommended fields.
